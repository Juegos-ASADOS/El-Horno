...
namespace El_Horno {
	...
	public:
		...
		void loadScene();
		Entity* loadPrefab(std::string name, bool handAt, std::string layer = "prueba");
		void setParams(luabridge::LuaRef entity, Entity* ent, Scene* s, bool handAt, std::string layer);
